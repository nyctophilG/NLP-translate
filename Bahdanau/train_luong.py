...
if __name__ == '__main__':
    ...
    # Using 'dot' as the scoring method (simplest and most common baseline for Luong)
    ...
    # 4. Save Models
    torch.save(encoder.state_dict(), 'encoder_luong.pth')
    torch.save(decoder.state_dict(), 'decoder_luong.pth')
    print("Models saved.")
